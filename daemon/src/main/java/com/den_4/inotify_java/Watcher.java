 ...
 * <dt>{@link Runnable Runnable}</dt>
 * <dd>Invoking the {@link Runnable#run() run method} of a
 * {@link Runnable Runnable}.</dd>
 * <dt>{@link CyclicBarrier CyclicBarrier}</dt>
 * <dd>Invoking await on a {@link CyclicBarrier
 * CyclicBarrier}.</dd>
 * <dt>{@link CountDownLatch}</dt>
 ...
 * <dt>{@link Semaphore Semaphore}</dt>
 * <dd>Acquiring a permit provided by the {@code Watcher} with a
 * {@link Semaphore semaphore}.</dd>
 * </dl>
 * </p>
 * <p>
...
public class Watcher extends ConcurrentReader {
    ...
    /**
     * Creates a watcher for the supplied path <em>p</em> and event type
     * <em>ev</em>. The provided {@link Runnable runnable} will be
    ...
    /**
     * Creates a watcher for the supplied path <em>p</em> and event type
     * <em>ev</em>. The provided {@link CyclicBarrier
    ...
    /**
     * Creates a watcher for the supplied path <em>p</em> and event type
     * <em>ev</em>. The provided {@link CountDownLatch
     ...
     * {@link Semaphore semaphore} when filesystem events
     * occur.
     *
     * @param path Path to watch
     * @param ev Event to watch for

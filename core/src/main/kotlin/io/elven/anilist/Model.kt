...
data class AniTitle(val romaji: String = "", val english: String = "") {
    fun match(title: String) = max(FuzzySearch.partialRatio(romaji.toLowerCase(), title.toLowerCase()), FuzzySearch.partialRatio(english.toLowerCase(), title.toLowerCase()))
}
